...
export const Header: FunctionalComponent<binotype.Context.Article<VNode> | binotype.Context.Section<VNode>> & {
...
Header.override = (
	article: binotype.Context.Article<VNode> | binotype.Context.Section<VNode>,
	children: VNode[],
