// Apply polyfills safely, avoiding conflicts with MockWindow during SSG
try {
	...
	// Silently fail if we can't set properties (e.g., during SSG with MockWindow)
	// This prevents the "Cannot set property HTMLElement" error
}
